...
const baseQuery =`select * from ${tb.tables.countyTest}`;

    //`SELECT * from ${tb.tables.countyTest} where (state_name = 'Florida');`;
// Above gives an error that sql command is not properly ended,
// without inner ; get poolAlias "default" not found in the connection pool cache error
